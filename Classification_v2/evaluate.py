...
Constants
'''
IDX = 0     # get this index form train.lesgoo() or the row index with hightst avg_val_pAUC in log_folds.csv
...
def predict():
    ...
    _, _, test_loader = dataset_dataloader.get_loader(test_hdf5_path=TEST_HDF5_PATH)
