...
MODEL_SAVE_PATH = "D:/ISIC 2024 - Skin Cancer Detection with 3D-TBP/model_resnet34_aug.pth"
LEARNING_RATE = 0.01
CLASSES = 1
EPOCH = 5


train_dl, test_dl = get_loader(batch=BATCH_SIZE)
    ...
    with open('log_res34_aug.csv', 'w', newline='') as f:
        ...
        for epoch in range(epochs):
            ...
            with torch.inference_mode():
                val_loss, val_acc, val_pre, val_rec, val_f1, val_aucroc = evaluate(test_dl, model)
